...
**Critério de aceite (testável):**
- [x] Salvar com nome, preço e categoria persiste o produto
- [x] Nome vazio é recusado *(RN-02)*
- [x] Preço zero ou negativo é recusado *(RN-06)*
- [x] Resumo respeita o limite de caracteres, com contador visível
- [x] Descrição aceita texto longo, sem limite
- [x] Rótulo oferece apenas as opções da lista fechada *(RN-07)*
- [x] Cada campo de texto indica em que canal aparece
- [x] Produto salvo nasce em Rascunho *(RN-14)*
