...
**Critério de aceite (testável):**
- [ ] Arquivo com extensão de imagem mas conteúdo inválido é recusado *(CA-06)*
- [ ] Upload válido gera exatamente quatro derivadas com nomes imutáveis
...
- [ ] Reenviar gera nomes novos, sem sobrescrever os anteriores *(RN-13)*
- [ ] Arquivo acima do limite de tamanho ou dimensão é recusado
