...
**Critério de aceite (testável):**
- [ ] Criar categoria com nome válido persiste e aparece na lista
- [ ] Nome duplicado é recusado com erro junto ao campo
- [ ] Nome vazio é recusado
- [ ] Lista sem categorias exibe o estado vazio, não uma tabela em branco
...
**Critério de aceite (testável):**
- [ ] Mover categoria para cima ou para baixo persiste a nova posição
- [ ] A primeira categoria não pode subir; a última não pode descer
- [ ] A numeração exibida acompanha a posição após o movimento
...
- [ ] **Após T-06** — revisar o SQL da migration inicial antes de aplicar em ambiente compartilhado
