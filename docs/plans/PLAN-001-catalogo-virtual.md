...
**Critério de aceite (testável):**
- [ ] Excluir categoria com produtos é recusado *(CA-11)*
- [ ] A mensagem informa a quantidade de produtos que impedem
- [ ] Produtos em Rascunho também impedem a exclusão
- [ ] Categoria sem produtos é excluída normalmente *(até T-26 acrescentar a segunda condição)*
